...
> Última actualización: **2026-07-14** · Actualizar en cada sesión de trabajo.

## Estado global

| Proyecto | Fase | Avance | ¿Comercializable hoy? | Bloqueador principal | Próximo hito | Deadline |
|---|---|---|---|---|---|---|
| **Kiwiano** | **~88%** — "olas 1-5" YA EN PRODUCCIÓN (14-jul): migraciones 015→019 corridas + cámara en vivo WebRTC celular→TV **validada en persona por Tavo, sin lag**. Modo TV 2.0, marcador en vivo, cuentas por club, ligas, fotos — todo activo. **Todo sin Stripe**, F5.2 sigue sin avance | 🟢 Alto — **activo, en otro chat**. HANDOFF **al día por primera vez en semanas** (se auto-actualizó 14-jul) | Casi — checkout escrito, falta probarlo con claves | **Tavo**: crear webhook en Stripe + pegar `sk_test_`/`whsec_` en Vercel (sin cambios) | Prueba de pago con tarjeta test en preview → merge a main con claves live | **2026-08-10** (fecha del chat de dev) |
